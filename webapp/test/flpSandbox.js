		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#tra0305epm0305-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"tra0305epm0305-display": {
								"semanticObject": "tra0305epm0305",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=tra0305.epm0305",
									"url": sap.ui.require.toUrl("tra0305/epm0305")
								}
							}
						}
					}
